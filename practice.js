...
var finalGreeting = (n) => {return `Hello, ${n}` }
...
function doubleCheck(arr){
  ...
  for(let i = 0; i < arr.length; i++ ){
    if(arr[i]==='chocolate'){ ifoundit = true}
  }
  if(ifoundit === false){arr.push('chocolate')}
  return arr
}
